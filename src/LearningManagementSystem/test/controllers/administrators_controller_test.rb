...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { first_name: @administrator.first_name, last_name: @administrator.last_name } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { first_name: @administrator.first_name, last_name: @administrator.last_name } }
